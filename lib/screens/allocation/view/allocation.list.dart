...
class AllocationUpdateForm extends StatefulWidget {
  ...
  final String email;
  final String number;
  const AllocationUpdateForm({Key? key, required this.email, required this.name, required this.number}) : super(key: key);
      ...
      child: Container(
        ...
        child: Center(
          child: Container(
            ...
            width: 800,
            decoration: BoxDecoration(
                color: Colors.white24.withOpacity(0.1), borderRadius: BorderRadius.circular(15)),
            child: Material(
