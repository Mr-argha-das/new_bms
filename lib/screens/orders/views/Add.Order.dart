...
class _AddOrdersState extends State<AddOrders> {
  final _trnxController = TextEditingController();
                                              ...
                                              callBack: (value) {
                                                ...
                                                ordersdata.then((value) {
                                                  setState(() {
                                                    ...
                                                    _inrTotalamountController
                                                            .text =
                                                        value.data[0].inrAmmount
                                                            .toString();
                                                    _audTotalamountController
                                                            .text =
                                                        value.data[0].audAmmount
                                                            .toString();
                                                    _audTotalamountController
                                                            .text =
                                                        value.data[0]
