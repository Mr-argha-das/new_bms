...
class _AddTeamApi implements AddTeamApi {
  ...
  @override
  Future<TeamUpdateResModel> updateTeamData(
    String teamid,
    TeamAddModel body,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TeamUpdateResModel>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TeamUpdateResModel.fromJson(_result.data!);
    return value;
  }
